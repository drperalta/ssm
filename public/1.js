...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm._v("\n    LOGIN\n    "),
      _c("a-button", { attrs: { type: "primary" } }, [_vm._v("Primary")]),
      _vm._v(" "),
      _c("a-button", [_vm._v("Default")]),
      _vm._v(" "),
      _c("a-button", { attrs: { type: "dashed" } }, [_vm._v("Dashed")]),
      _vm._v(" "),
      _c("a-button", { attrs: { type: "danger" } }, [_vm._v("Danger")]),
      _vm._v(" "),
      _c("a-button", { attrs: { type: "link" } }, [_vm._v("Link")])
    ],
    1
  )
}
